...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  return (
    <div className="border border-gray-200 mb-10 rounded-lg overflow-hidden transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg bg-white">
...
export default function ProductsPage() {
  ...
  return (
    <div className="bg-white">
      {/* <div className="container mt-12 mx-auto px-4 max-w-7xl"> */}
