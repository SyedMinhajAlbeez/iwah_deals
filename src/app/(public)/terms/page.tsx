...
export default function TermsPage() {
  return (
    <>
      <main className="w-full min-h-screen bg-white px-6 py-10">
        {/* Card */}
        <div className="max-w-[1338px] mx-auto p-10">
          {/* Header */}
          <h1 className="text-2xl font-bold text-gray-900 leading-tight">
            Shop Terms &amp; Conditions
          </h1>
          <p className="mt-2 text-sm font-semibold text-gray-500 tracking-wide uppercase">
          ...
          <section className="mb-8">
            <h2 className="text-base font-semibold text-gray-900 leading-[26px] uppercase tracking-wide mb-3">
              Definitions &amp; Interpretation
            </h2>
            <p className="text-sm text-gray-600 leading-[26px]">
              In the following Terms and Conditions of sale, unless the context requires otherwise:
            </p>
            <ul className="mt-2 text-sm text-gray-600 leading-[26px] list-none space-y-1 pl-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-[26px]">
              The prices charged by and payable to Shop will be the ruling prices applicable at the time of order placement, provided that the Products are accepted for delivery within a reasonable time. Prices are subject to change without notice. Recommended retail prices are provided for indicative purposes only and there is no obligation for Shop to comply with that recommendation. It is agreed that should the Customer fail for any reason to acquire the quantity of Products sold then without limiting Shop's other rights and remedies the unit price charged for the goods sold may be amended to take into account any variation in the total quantity purchased by the Customer. Prices include GST, but do not include any other tax or duty, which is in addition to the price and is to be paid by the Customer at the time of payment for the Products.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-3 text-sm text-gray-600 leading-[26px]">
              <p>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-3 text-sm text-gray-600 leading-[26px]">
              <p>
                The means of delivering the Products to the Customer will be at Shop's discretion. Shop reserves the right to deliver Products in part deliveries. In the event that Shop incurs additional costs for meeting special (i.e. Tasmania / Northern Territory Deliveries) or urgent delivery arrangements, these additional costs may be charged to the Customer and may include the cost of airfreight where it is not the normal method of delivery. The Customer agrees to accept delivery of the Products sold at any time during normal business hours.
              </p>
              <p>
