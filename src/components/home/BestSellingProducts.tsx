...
const BestSellingProducts: FC = () => {
  ...
  return (
    <section className="w-full py-8">
      {/* <div className="container mx-auto px-4 border-2 border-[#D4A574] rounded-lg p-4"> */}
      <div
        className="container mx-auto px-4 border-2 border-[#D4A574] rounded-lg p-4"
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6 ml-2 mt-1">
          ...
          <Link
            ...
            className="text-[10px] sm:text-xs md:text-sm font-medium text-[#0093D0] border border-[#0093D0] px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-1.5 rounded-full hover:bg-[#0093D0] hover:text-white transition-colors whitespace-nowrap"
          >
            See All Products
          </Link>
        </div>
