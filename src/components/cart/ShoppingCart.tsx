...
import { removeLocalItem, updateLocalQty, clearLocalCart } from "@/store/slices/cart-slice";
                            ...
                            {discountOpen && (
                                <div className="mt-2 flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-3 py-1.5 text-xs border border-amber-300 rounded-lg bg-white/60 focus:outline-none focus:border-amber-500"
                                    />
                                    <button className="px-3 py-1.5 text-xs font-medium text-white bg-amber-500 rounded-lg hover:bg-amber-600 transition-colors">
                                        Apply
                                    </button>
                                </div>
                            )}
